<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPageManager.master" AutoEventWireup="true" CodeFile="TrainingApproval.aspx.cs" Inherits="Manager_TrainingApproval" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="Manager.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center><a><asp:Label ID="Label1" runat="server" Text="REGISTRATION STATUS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label></a></center>
    <br />
        ...
        <div style="height: 400px; overflow: auto;">
            <asp:GridView ID="gridEmployee" CssClass="mydatagrid" HeaderStyle-CssClass="header" OnRowCommand="gridEmployee_RowCommand" RowStyle-CssClass="rows" runat="server" AutoGenerateColumns="false" EmptyDataText="No data uploaded" Font-Size="12pt">
                <Columns>
                    ...
                    <asp:ButtonField ItemStyle-HorizontalAlign="Center" HeaderText="" ButtonType="Button" ControlStyle-CssClass="buttonGridApprove" Text="APPROVE" CommandName="Approve" HeaderStyle-Width="100px" ControlStyle-Width="150px" />
                    <asp:ButtonField ItemStyle-HorizontalAlign="Center" HeaderText="" ButtonType="Button" ControlStyle-CssClass="buttonGridDecline" Text="DECLINE" CommandName="Decline" HeaderStyle-Width="100px" ControlStyle-Width="150px" />
                </Columns>
            </asp:GridView>
        </div>
    </div>--%>
