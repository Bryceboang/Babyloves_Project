<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPageManager.master" AutoEventWireup="true" CodeFile="TrainingRegister.aspx.cs" Inherits="Manager_TrainingRegister" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="Manager.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center><a><asp:Label ID="Label1" runat="server" Text="REGISTER EMPLOYEE" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label></a></center>
    <br />
        ...
        <div class="main_box_train">
            <div class="content_train">
                <div class="left_content_train2">
                    <center>
                    <asp:Label ID="Label13" runat="server" Text="REGISTER" ForeColor="White" Font-Bold="True"></asp:Label>
                    <br />
                    <br />
                    <br />
                    <asp:Label ID="Label10" runat="server" Text="Department:" ForeColor="White" Font-Bold="True"></asp:Label>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                        <asp:Label ID="Label12" runat="server" Text="Section:" ForeColor="White" Font-Bold="True"></asp:Label>
                    <br />
                    <br />
   ...
   <%-- <center>
    ...
    <div class="container">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="cmbSection" CssClass="custom-dropdown" AutoPostBack="true" OnSelectedIndexChanged="cmbSection_SelectedIndexChanged" runat="server"></asp:DropDownList>
        <br />
        <br />
        <asp:Label ID="Label6" runat="server" Text="LIST OF EMPLOYEES:" Font-Size="XX-Large"></asp:Label>
        <br />
        <div style="height: 400px; overflow: auto;">
            <asp:GridView ID="gridEmployee" CssClass="mydatagrid" HeaderStyle-CssClass="header" OnRowCommand="gridEmployee_RowCommand" RowStyle-CssClass="rows" runat="server" AutoGenerateColumns="false" EmptyDataText="No data uploaded" Font-Size="12pt">
                <Columns>
                    ...
                    <asp:ButtonField ItemStyle-HorizontalAlign="Center" HeaderText="Registration" ButtonType="Button" ControlStyle-CssClass="buttonGrid" Text="REGISTER" CommandName="Nominate" HeaderStyle-Width="100px" ControlStyle-Width="150px" />
                </Columns>
            </asp:GridView>
        </div>
    </div>--%>
