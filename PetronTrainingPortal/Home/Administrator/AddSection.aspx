<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Administrator/Administrator.master" AutoEventWireup="true" CodeFile="AddSection.aspx.cs" Inherits="Home_Administrator_AddSection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main_container_dept_home ">
        <div class="main_box_dept">
            <center><asp:Label ID="lblTitle" runat="server" Text="SECTION" ForeColor="White" Font-Size="16" Font-Bold="True"></asp:Label></center>
            <div class="content_dept">
                ...
                <div class="right1_content_sec_home">
                    <center>
                    <asp:GridView ID="gridSec" runat="server" AutoGenerateColumns="false" CssClass="mydatagrid" EmptyDataText="No data uploaded" Font-Size="8pt" HeaderStyle-CssClass="header" PagerStyle-CssClass="pager" RowStyle-CssClass="rows">
                        <Columns> 
    ...
    <center>
        <asp:Button ID="btnClear" CssClass="buttonGrid" runat="server" Text="Clear" ValidationGroup="sec" Font-Size="10pt" Width="116px"></asp:Button>
        &nbsp;
        <asp:Button ID="btnSave" CssClass="buttonGrid" runat="server" Text="Save" ValidationGroup="sec" Font-Size="10pt" Width="116px"></asp:Button>
    </center>
</asp:Content>
