<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Administrator/Administrator.master" AutoEventWireup="true" CodeFile="AddUser.aspx.cs" Inherits="Home_Administrator_AddUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <asp:Button ID="btnClear" CssClass="buttonGrid" runat="server" Text="Clear" Font-Size="10pt" Width="116px"></asp:Button>
        &nbsp;
        <asp:Button ID="btnSave" CssClass="buttonGrid" runat="server" Text="Save" ValidationGroup="useradd" Font-Size="10pt" Width="116px"></asp:Button>
        &nbsp;
        <asp:Button ID="btnReset" CssClass="buttonGrid" runat="server" Text="Reset Password" Enabled="False" Font-Size="10pt" Width="195px" />
    </center>
</asp:Content>
