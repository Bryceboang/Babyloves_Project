<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Page/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ReportAdmin.aspx.cs" Inherits="ReportAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center>
            <h2>List of Approved Employees</h2>
                <div class="container">
    ...
    <br />
                    ...
                    <asp:ButtonField ItemStyle-HorizontalAlign="Center"  HeaderText="REJECT" ButtonType="Button" ControlStyle-CssClass="buttonGrid" Text="REJECT" CommandName="Reject"  HeaderStyle-Width="100px" ControlStyle-Width="150px" />
                    </Columns>
                    </asp:GridView>
                    <br />
                    <br />
