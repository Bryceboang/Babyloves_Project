<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisor/MasterPageSupervisor.master" AutoEventWireup="true" CodeFile="ViewStatus.aspx.cs" Inherits="Supervisor_ViewStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="main_box_train">
            <div class="content_train">
                <div class="left_content_train">
                    <center>
                    <br />
                    <asp:Label ID="Label1" runat="server" Text="Training Code" ForeColor="White" Font-Bold="True"></asp:Label>
                    <br />
                    <br />
                ...
                <div class="right_content_train">
                    ...
                    <br />
                    <center><asp:Label ID="lblTrainingTitle" runat="server" ForeColor="White" Font-Size="15" Font-Bold="True"></asp:Label>
        ...
        <div class="main_box_train">
            <div class="content_train">
                ...
                <div class="right_content_train2">
                    ...
                    <asp:GridView ID="gridEmployee" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" runat="server" AutoGenerateColumns="false" EmptyDataText="No data uploaded" Font-Size="8pt">
                        <Columns>
    ...
    <div class="container">
        ...
        <div style="height: 400px; overflow: auto;">
            <asp:GridView ID="gridEmployee" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" runat="server" AutoGenerateColumns="false" EmptyDataText="No data uploaded" Font-Size="12pt">
                <Columns>
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" DataField="EmployeeNumber" HeaderText="EMPLOYEE NUMBER" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="250px" DataField="FullName" HeaderText="FULLNAME" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" DataField="DepartmentName" HeaderText="DEPARTMENT" />
